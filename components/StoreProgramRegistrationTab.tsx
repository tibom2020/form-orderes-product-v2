                  ...
                  <table className="tbq2-sticky-table w-full text-left text-xs min-w-[1080px] sm:min-w-[1160px]">
                    <thead>
                      <tr className="text-[10px] font-bold uppercase tracking-wider text-[#2d3b36] dark:text-slate-200 border-b border-[#c0c9c3]/40 dark:border-slate-600">
                        <th className="sticky left-0 z-[2] py-3 px-3 min-w-[14rem] max-w-[min(22rem,45vw)] bg-sky-100 dark:bg-sky-950/95 backdrop-blur border-r border-sky-200/60 dark:border-sky-800/50 shadow-[2px_0_0_rgba(0,0,0,0.03)] dark:shadow-[2px_0_0_rgba(0,0,0,0.2)]">
                          Khách hàng
                        </th>
                    ...
                    <tbody className="divide-y divide-[#c0c9c3]/20 dark:divide-slate-600/40">
                      {filteredTableRows.length === 0 ? (
                        ...
                        filteredTableRows.map((row, idx) => {
                          ...
                          >
                            <td className="sticky left-0 z-[1] py-3 px-3 min-w-[14rem] max-w-[min(22rem,45vw)] border-r border-sky-200/40 dark:border-sky-800/30 bg-sky-100 group-hover/row:bg-sky-200/95 dark:bg-sky-950 dark:group-hover/row:bg-sky-900/95 backdrop-blur shadow-[2px_0_0_rgba(0,0,0,0.03)] dark:shadow-[2px_0_0_rgba(0,0,0,0.2)]">
