...
export const PRODUCTS: Product[] = [
  ...
  { id: 10, name: 'BISOLVON KIDS 60ML BOTx1 VN', minOrder: '1', minOrderQuantity: 1, price: 40567, type: 'Local', promotion: 'KM 9.85% đến 28.02.2026', basePrice: 38635, note: 'Hạn dùng: ngày tháng 1/2027 ĐƠN DUYỆT', image: 'https://i.postimg.cc/SKkFP6Ww/bi-siro.webp' },
  ...
  { id: 29, name: 'ENTEROGERMINA 2 billion/5ml B/20 bottle', minOrder: '1', minOrderQuantity: 1, price: 169240, type: 'Import', basePrice: 161181, promotion: 'Mua 1h ck 0.99% (đến 28.02.2026)', image: 'https://i.postimg.cc/SK2rsG43/images.webp' },
  { id: 12, name: 'ENTEROGERMINA GUT RESTORE ( 4B)', minOrder: '1', minOrderQuantity: 1, price: 305130, type: 'Import', basePrice: 290600, promotion: 'Mua 6h ck 4.93% (đến 28.02.2026)', image: 'https://i.postimg.cc/pdRbSffx/entero-4b.webp' },
  ...
  { id: 14, name: 'BISOLVON 8MG TAB', minOrder: '1', minOrderQuantity: 1, price: 63901, type: 'Import', promotion: 'ck 4.93% CTKM đến 28.02.2026', basePrice: 60858, note: 'Hạn dùng: 5/2027 và 6/2027 ĐƠN DUYỆT', image: 'https://i.postimg.cc/xdnDZvvr/bi-vien.webp' },
