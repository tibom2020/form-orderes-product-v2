...
const LandingPage: React.FC<LandingPageProps> = ({ currentEmployee, marketingData, onReloadData, onCustomerSelect, onUpdateRecord }) => {
            ...
            <div className="flex gap-2">
                ...
                <button 
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-bold transition-all border ${
                        imageFilterMode === 'HAS_IMAGE' ? 'bg-green-50 text-green-700 border-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-800' :
                        ...
                        return (
                            ...
                            >
                               ...
                               <div className="flex items-center gap-2 flex-shrink-0">
                                    ...
                                    <div className={`w-7 h-7 flex items-center justify-center rounded-lg text-[10px] font-black border transition-all ${
                                         hasLocal 
